...
function Bio() {
    return (
        <div className="flex flex-col sm:flex-row sm:h-[550px]
                        bg-primary
                        my-5
                        rounded-3xl">
            <img src={images.carlBioImg} alt="Carl Hynson" className="m-16 sm:basis-2/5 rounded-3xl
            ...
            <div className="sm:basis-3/5 sm:mt-16 mb-6 mx-10 ">
                ...
                <p className="text-base md:text-lg font-semibold text-gray-green">
                    ...
                    <span className="font-extrabold italic"> 3 internships</span> under my belt. Excited about
